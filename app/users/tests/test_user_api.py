...
class PublicUserAPITests(TestCase):
    ...
    def test_create_token_for_user(self):
        """Test generates token for added credentials"""
        user_details = {
            'email': 'testTokenCreation@example.com',
            'password': 'generateToken',
            'name': 'Test Create Token for User',
        }
    ...
    def test_create_token_bad_credentials(self):
        ...
        user_details = {
            'email': 'testCreateTokenBadCredentials@example.com',
            'password': 'goodpass',
            'name': 'Test Create Token for User with Bad Credentials',
        }
    ...
    def test_create_token_blank_password(self):
        ...
        user_details = {
            'email': 'testCreateTokenBlankPassword@example.com',
            'password': 'goodpass',
            'name': 'Test Create Token for User with Bad Credentials',
        }
...
class PrivateUserApiTests(TestCase):
    ...
    def test_retrieve_profile_success(self):
        """Tests retrieve profile for authenticated user"""
        res = self.client.get(ME_URL)
    ...
    def test_post_me_not_allowed(self):
        """Tests POST is not allowed fopr the me endpoint"""
